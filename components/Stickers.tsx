...
export function StickerBobaCup({ size = 64 }: { size?: number }) {
    return (
...
export function StickerMatchaLeaf({ size = 48 }: { size?: number }) {
    return (
...
export function StickerBobaPearls({ size = 48 }: { size?: number }) {
    return (
        <svg width={size} height={size} viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" className="inline-block drop-shadow-lg">
...
export function StickerHeart({ size = 36 }: { size?: number }) {
    return (
